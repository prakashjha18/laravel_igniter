       ...
       <nav class="collapse navbar-collapse navbar-right">
          <ul id="nav" class="nav navbar-nav menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                       <li><a href="index.html">Schemes</a></li>
                       <li><a href="index-text.html">Templates</a></li>
                       <li><a href="onepage-slider.html">Live Sessions</a></li>
                       <li><a href="onepage-text.html">Tutorials</a></li>
                    </ul>
                 </li>
